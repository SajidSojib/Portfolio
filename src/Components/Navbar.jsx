...
const Navbar = () => {
  ...
  return (
    <div className="px-4 py-3 mx-auto sm:max-w-xl md:max-w-full text-base-100 lg:max-w-screen-xl md:px-24 lg:px-8 ">
      <div className="relative flex items-center justify-between">
        ...
        >
          <span className="text-xl font-bold tracking-wide">
            <span className="text-primary">{'<'}</span>Sajid <span className="text-primary">{'/>'}</span>
          </span>
        </Link>
